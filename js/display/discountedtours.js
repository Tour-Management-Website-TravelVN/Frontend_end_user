...
$(function () {
    ...
    fetch(buildUrl("http://localhost:8080/tourunit/foundtourlist", { type: 2 }), {
        method: "GET",
        credentials: 'include',
        headers: {
    ...
    function displayTour(tourUnit) {
        ...
        let item = `
            <div class="packages-item rounded shadow-primary mb-3 me-3">
                    <div class="packages-img">
                        ...
                        <div class="discount bg-warning">${tourUnit.discount.discountName}</div>
                    </div>
        ...
        let $item = $(item);
        $('#discountedtours-caro').append($item);
        $item.click(function(){
