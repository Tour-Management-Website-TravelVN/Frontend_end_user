document.addEventListener('DOMContentLoaded', function () {
    $('#btnFind').click(function () {
        ...
        sessionStorage.setItem("sst", JSON.stringify(data)); // => Không bị mất khi load hoặc chuyển trang
        ...
        fetch(apiUrlWithParams, {
            ...
            .then(data => {
                ...
                if (data.code == 0) {
                    ...
                    result = JSON.parse(localStorage.getItem("foundtours"));
                    ...
                    <div class="packages-img rounded-0 img-filter h-100 w-30 img-lg-width">
                        <img class="card-img-top object-fit-cover h-100" src="${tour.tour.firstImageUrl}"
                                    ...
                                    <div class="card-content my-2 mx-3 w-100">
                                        <h5 class="text-primary fw-bold text-justify py-0 my-0">${tourName}</h5>
